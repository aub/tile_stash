...
begin
  ...
  Jeweler::Tasks.new do |gemspec|
    gemspec.name = 'tile_stash'
    gemspec.summary = 'A tile caching tool for rack-based web frameworks.'
    gemspec.email = 'aubreyholland@gmail.com'
    gemspec.homepage = 'http://github.com/aub/tile_stash/tree/master'
    gemspec.description = 'Hooya!'
...
Rake::RDocTask.new do |rdoc|
  ...
  rdoc.options << '--webcvs=http://github.com/aub/tile_stash/tree/master/'
end
